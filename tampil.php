...
if (isset($_POST["submit"])) {
  ...
  $query = "SELECT * FROM product_detail WHERE nama LIKE '%$nama%' ORDER BY nama ASC";
  $result = mysqli_query($connectdb, $query);

  if ($result) {
    $pesan = "Data <b> $nama </b> berhasil ditambahkan ";
  }
  else {
  ...
  $query = "SELECT * FROM product_detail ORDER BY nama ASC";
  $result = mysqli_query($connectdb, $query);
}
?>
<html>
